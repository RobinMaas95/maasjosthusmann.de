...
export const copy: Record<Language, Copy> = {
	en: {
		...
		proof: [
			...
			{ id: '03', focus: 'AI platform · In-house', title: 'LLM Gateway for AI Coding Tools', body: 'Engineers and data scientists needed AI coding assistants, but direct provider subscriptions did not meet company data rules. As part of the platform team, I helped build the delivery pipeline, added identity-based authentication, and led the design of usage accounting and spending limits. The gateway handles approved model access and provider routing behind one setup script. It currently serves about 100 beta users.' },
	...
	de: {
		...
		proof: [
			...
			{ id: '03', focus: 'AI-Plattform · Festanstellung', title: 'LLM-Gateway für AI-Coding-Tools', body: 'Entwickler und Data Scientists brauchten AI-Coding-Assistenten, doch direkte Provider-Abos erfüllten die Datenschutzvorgaben des Unternehmens nicht. Als Teil des Plattform-Teams habe ich die Delivery-Pipeline des Gateways mitaufgebaut, identitätsbasierte Authentifizierung ergänzt und das Design sowie die Implementierung der Nutzungsabrechnung und Ausgabenlimits geleitet. Das Gateway regelt Zugriff auf freigegebene Modelle und Provider-Routing hinter einem einzigen Setup-Skript. Aktuell nutzen es ca. 100 Beta-User.' },
