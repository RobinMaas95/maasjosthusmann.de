...
export function Carousel({
  ...
  const scrollBy = useCallback(direction => {
    ...
    el.scrollBy({
      ...
      left: (isRtlElement(el) ? -1 : 1) * direction * Math.max(amount, itemWidth),
