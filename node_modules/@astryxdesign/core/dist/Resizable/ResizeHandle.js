...
const dynamicStyles = {
  hitAreaOffsetX: dir => [_temp, {
    "--x-qthpiu": `translate(calc(${dir} * (3px + ${spacingVars['--spacing-1']}) - 6.5px), -50%)` != null ? `translate(calc(${dir} * (3px + ${spacingVars['--spacing-1']}) - 6.5px), -50%)` : undefined,
    "--x-sj6hyi": `translate(calc(${dir} * (3px + ${spacingVars['--spacing-1']}) + 6.5px), -50%)` != null ? `translate(calc(${dir} * (3px + ${spacingVars['--spacing-1']}) + 6.5px), -50%)` : undefined
  }],
  hitAreaOffsetY: dir => [_temp2, {
    "--x-transform": `translate(-50%, calc(${dir} * (3px + ${spacingVars['--spacing-1']}) - 6.5px))` != null ? `translate(-50%, calc(${dir} * (3px + ${spacingVars['--spacing-1']}) - 6.5px))` : undefined
  }],
...
export function ResizeHandle({
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("div", {
      ...
      hitBiasDir == null ? isHorizontal ? styles.hitAreaCenteredX : styles.hitAreaCenteredY : isHorizontal ? dynamicStyles.hitAreaOffsetX(hitBiasDir) : dynamicStyles.hitAreaOffsetY(hitBiasDir), isDisabled && styles.disabled),
