...
export function useInputStatusIcon({
  ...
  const [tapOpen, setTapOpen] = useState(undefined);
  ...
  const shouldRenderIcon = !!status && !isInGroup && statusVariant !== 'detached';
  if (!shouldRenderIcon) {
    return {
      statusIcon: null,
  ...
  return {
    statusIcon: /*#__PURE__*/_jsxs(_Fragment, {
