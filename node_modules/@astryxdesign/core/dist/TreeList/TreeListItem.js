...
export function TreeListItem({
  ...
  const indentDistance = hasChildren ? `calc(${nestedLevel} * var(--tree-list-indent))` : `calc(${nestedLevel} * var(--tree-list-indent) + ${spacingVars['--spacing-4']} + ${spacingVars['--spacing-2']})`;
  const indentStyle = {
