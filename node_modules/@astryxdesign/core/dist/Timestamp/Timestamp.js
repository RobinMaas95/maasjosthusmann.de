...
export function Timestamp({
  ...
  useDevWarning('Timestamp', `could not parse value ${JSON.stringify(value)} as a date. Rendering nothing.`, !isValidDate);
  ...
  const showTooltip = hasTooltip && (effectiveFormat === 'relative' || entries !== undefined);
  ...
  if (showTooltip) {
    ...
    const tooltipContent = entries === undefined ? fullAbsoluteText : /*#__PURE__*/_jsx("dl", {
      ...{
        className: "xrvj5dj x1pmbctz x1tw44j4 x10im51j xrxpjvj"
      },
      children: formatTooltipLines(date, entries).map((line, index) =>
      /*#__PURE__*/
      ...
      _jsxs(Fragment, {
        children: [/*#__PURE__*/_jsx("dt", {
          ...{
            className: "x10im51j xrxpjvj xyri2b xepvkrk"
          },
          children: line.label ?? ''
        }), /*#__PURE__*/_jsx("dd", {
          ...{
