...
export function TextArea({
  ...
  return /*#__PURE__*/_jsxs(Field, {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      }), stylex.props(inputWrapperStyles.base, styles.wrapper, textareaSizeStyles[size], effectivelyDisabled && inputWrapperStyles.disabled, status && inputStatusBorderStyles[status.type], status && !effectivelyDisabled && inputStatusHoverShadowStyles[status.type], status && inputStatusFocusWithinStyles[status.type], xstyle), className, style),
