...
var errorForFn = (name) => new Error(`Unexpected 'stylex.${name}' call at runtime. Styles must be compiled by '@stylexjs/babel-plugin'.`);
...
var unstable_conditional = function stylexConditional(_value) {
  throw errorForFn("unstable_conditional");
};
var unstable_defineVarsNested = function stylexDefineVarsNested(_styles) {
  throw errorForFn("unstable_defineVarsNested");
};
var unstable_defineConstsNested = function stylexDefineConstsNested(_styles) {
  throw errorForFn("unstable_defineConstsNested");
};
var unstable_createThemeNested = (_baseTokens, _overrides) => {
...
var toKebabCase = (str) => str.replace(/([A-Z])/g, "-$1").toLowerCase();
...
// node_modules/@astryxdesign/core/dist/naming.js
...
//# sourceMappingURL=chunk-WEKT4OCY.js.map
