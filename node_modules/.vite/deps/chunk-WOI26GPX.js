...
// node_modules/@astryxdesign/core/dist/i18n/useTranslator.js
var import_react2 = __toESM(require_react(), 1);

// node_modules/@astryxdesign/core/dist/i18n/InternationalizationContext.js
var import_react = __toESM(require_react(), 1);
var InternationalizationContext = (0, import_react.createContext)({
  locale: "en",
  direction: "ltr",
  messages: {}
});
...
var _a;
var IntlMessageFormat = (_a = class {
  constructor(message, locales = _a.defaultLocale, overrideFormats, opts) {
    this.formatterCache = {
      number: {},
      dateTime: {},
      pluralRules: {}
    ...
    this.resolvedLocale = _a.resolveLocale(locales);
    if (typeof message === "string") {
      this.message = message;
      if (!_a.__parse) throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");
      const { ...parseOpts } = opts || {};
      this.ast = _a.__parse(message, {
        ...parseOpts,
        locale: this.resolvedLocale
      });
    } else this.ast = message;
    if (!Array.isArray(this.ast)) throw new TypeError("A message must be provided as a String or AST.");
    this.formats = mergeConfigs(_a.formats, overrideFormats);
    this.formatters = opts && opts.formatters || createDefaultFormatters(this.formatterCache);
  }
  static get defaultLocale() {
    if (!_a.memoizedDefaultLocale) _a.memoizedDefaultLocale = new Intl.NumberFormat().resolvedOptions().locale;
    return _a.memoizedDefaultLocale;
  }
}, _a.memoizedDefaultLocale = null, _a.resolveLocale = (locales) => {
...
// node_modules/@astryxdesign/core/locales/en.json
var en_default = {
...
// node_modules/@astryxdesign/core/dist/i18n/resolve.js
var EN_CATALOG = en_default;
...
function resolve(key, values, locale, messages, overrides) {
...
function useTranslator() {
  const ctx = (0, import_react2.use)(InternationalizationContext);
  return (0, import_react2.useCallback)((key, values) => resolve(key, values, ctx.locale, ctx.messages, ctx.overrides), [ctx.locale, ctx.messages, ctx.overrides]);
}

// node_modules/@astryxdesign/core/dist/i18n/InternationalizationProvider.js
var import_react3 = __toESM(require_react(), 1);

// node_modules/@astryxdesign/core/dist/i18n/getLocaleDirection.js
...
function InternationalizationProvider({
  ...
  return (0, import_jsx_runtime.jsx)(InternationalizationContext, {
    value,
    children
  });
}
...
// node_modules/@astryxdesign/core/dist/i18n/useDirection.js
var import_react4 = __toESM(require_react(), 1);

export {
  useTranslator
};
//# sourceMappingURL=chunk-WOI26GPX.js.map
