...
// node_modules/@astryxdesign/core/dist/Icon/defaultIcons.js
...
var defaultIcons = {
  /** ✕ — two diagonal lines */
  close: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
  ...
  /** ▾ — downward chevron */
  chevronDown: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      d: "M6 9l6 6 6-6"
    })
  ...
  /** ‹ — left chevron */
  chevronLeft: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      d: "M15 6l-6 6 6 6"
    })
  ...
  /** › — right chevron */
  chevronRight: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      d: "M9 6l6 6-6 6"
    })
  ...
  /** ✓ — checkmark */
  check: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      d: "M5 13l4 4L19 7"
    })
  ...
  success: (0, import_jsx_runtime.jsx)("svg", {
    ...solidSvgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
  ...
  error: (0, import_jsx_runtime.jsx)("svg", {
    ...solidSvgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
  ...
  warning: (0, import_jsx_runtime.jsx)("svg", {
    ...solidSvgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
  ...
  info: (0, import_jsx_runtime.jsx)("svg", {
    ...solidSvgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
  ...
  /** 📅 — calendar */
  calendar: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
  ...
  /** 🕐 — clock */
  clock: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
  ...
  /** ↗ — external link arrow */
  externalLink: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
    children: [(0, import_jsx_runtime.jsx)("path", {
  ...
  menu: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    strokeWidth: 2,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  moreHorizontal: (0, import_jsx_runtime.jsxs)("svg", {
    ...solidSvgProps,
    children: [(0, import_jsx_runtime.jsx)("circle", {
      cx: "5",
      cy: "12",
  ...
  search: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
    children: [(0, import_jsx_runtime.jsx)("circle", {
      cx: "11",
      cy: "11",
  ...
  arrowUp: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  arrowDown: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  arrowsUpDown: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  funnel: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  eyeSlash: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  viewColumns: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  copy: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
    children: [(0, import_jsx_runtime.jsx)("path", {
  ...
  checkDouble: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
    children: [(0, import_jsx_runtime.jsx)("path", {
      d: "M2 13l4 4L14 7"
    }), (0, import_jsx_runtime.jsx)("path", {
  ...
  wrench: (0, import_jsx_runtime.jsx)("svg", {
    ...svgProps,
    children: (0, import_jsx_runtime.jsx)("path", {
  ...
  stop: (0, import_jsx_runtime.jsx)("svg", {
    ...solidSvgProps,
    children: (0, import_jsx_runtime.jsx)("rect", {
      x: "6",
      y: "6",
  ...
  microphone: (0, import_jsx_runtime.jsxs)("svg", {
    ...svgProps,
    children: [(0, import_jsx_runtime.jsx)("path", {
...
// node_modules/@astryxdesign/core/dist/Icon/globalIconRegistry.js
var globalRegistry = {};
...
//# sourceMappingURL=chunk-WP43CGFQ.js.map
